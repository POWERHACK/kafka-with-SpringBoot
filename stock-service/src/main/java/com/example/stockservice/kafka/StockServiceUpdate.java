...
@Service
public class StockServiceUpdate {
	
	private static final Logger LOGGER = LoggerFactory.getLogger(StockServiceUpdate.class);

    private NewTopic topic;

    private KafkaTemplate<String, OrderEventBase> kafkaTemplate;

    public StockServiceUpdate(NewTopic topic, KafkaTemplate<String, OrderEventBase> kafkaTemplate) {
        this.topic = topic;
